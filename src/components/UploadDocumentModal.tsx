...
const UploadDocumentModal = ({ properties = [] }: UploadDocumentModalProps) => {
  ...
  const handleSubmit = () => {
    ...
    // Here you would save the documents to the selected property
    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
        ...
        <div className="space-y-6">
          ...
          {/* Documents Section - Only show if property is selected */}
          {selectedProperty && (
            <Card>
              <CardHeader>
          ...
          <div className="flex justify-end space-x-4">
            ...
            <Button onClick={handleSubmit} disabled={!selectedProperty || documents.length === 0}>
              Upload Documents
            </Button>
          </div>
        </div>
