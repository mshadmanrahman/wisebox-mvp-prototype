    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-background via-muted/30 to-background p-4">
      ...
      <div className="w-full max-w-md relative">
        ...
        <div className="flex items-center justify-center space-x-2 mb-8">
          <div className="flex h-12 w-12 items-center justify-center rounded-lg bg-gradient-to-br from-primary to-primary-glow shadow-lg">
        ...
        <Card className="shadow-xl border-border/50 bg-card/80 backdrop-blur-sm">
          <CardHeader className="text-center">
            ...
            <CardDescription>
              Sign in to manage your properties securely
            </CardDescription>
          </CardHeader>
          <CardContent>
